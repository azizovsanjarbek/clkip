$(function () {
  ...
  var chart = {
    series: [
      { name: "Приход:", data: [1890826,2297604,7244552,1682926,1377799,10154140,8226619,1315537,1523437,1315537,0,0,0] }
    ],
    ...
    xaxis: {
      ...
      categories: ["1\/09","2\/09","3\/09","4\/09","5\/09","6\/09","7\/09","8\/09","9\/09","10\/09","11\/09","12\/09","13\/09"],
      labels: {
  ...
  var chartline = {
    ...
    series: [
      {
        name: "склад 3308",
        data:[10399118,9074403,50125031,2575708,2601381,18147065,8436819,13901515,6189436,8596836,0,0,0]
      }
    ],
    stroke: {
      curve: "smooth",
